...
class NetModels:
    ...
    def setup_places_model(path_to_models):
        ...
        prototxt_path = path_to_models + 'models/googlenet_places205/deploy_places205.protxt'
        caffemodel_path = path_to_models + 'models/googlenet_places205/googlelet_places205_train_iter_2400000.caffemodel'  # From the model zoo
    ...
    def setup_googlenet_model(path_to_models):
        prototxt_path = path_to_models + 'models/bvlc_googlenet/deploy.prototxt'
        caffemodel_path = path_to_models + 'models/bvlc_googlenet/bvlc_googlenet.caffemodel'  # this model comes with caffe
    ...
    def setup_flickr_model(path_to_models):
        prototxt_path = path_to_models + 'models/finetune_flickr_style/deploy.prototxt'
        caffemodel_path = path_to_models + 'models/finetune_flickr_style/finetune_flickr_style.caffemodel'  # this model comes from bvlc flickr example
